...
public abstract class MyGame extends Game {
	...
	// public static Map<String, NativeFont> fonts = new HashMap<String,
	// NativeFont>();
	public static final String DEFAULT_CHARS = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890!`?'.,;:()[]{}<>|/@\\^$-%+=#_&~*";

	public static NativeFont minFont = null;
	// public static NativeFont midFont = null;
	public static NativeFont maxFont = null;
...
//    }
	...
	protected void setFontSize(int maxFontSize, int minFontSize) {
		maxFont = new NativeFont(new NativeFontPaint(maxFontSize));
		maxFont.appendText(DEFAULT_CHARS);
		minFont = new NativeFont(new NativeFontPaint(minFontSize));
		minFont.appendText(DEFAULT_CHARS);
	}
