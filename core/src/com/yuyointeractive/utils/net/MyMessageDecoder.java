...
public class MyMessageDecoder {
  ...
  // public String decoder(final ResponseListener listener, InputStream input,
  // RSAPublicKey key) throws Exception {
  public void decoder(final MyResponseListener listener, InputStream input) throws Exception {
  ...
  private void receiveMsg(MyResponseListener listener, InputStream input, int length) throws IOException {
    type = getType(input);
  ...
  private void receiveMsg(MyResponseListener listener, int length) throws IOException {
    type = getType();
    if (listener != null) {
