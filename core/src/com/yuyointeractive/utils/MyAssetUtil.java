...
public class MyAssetUtil {
	...
	return new BitmapFont(Gdx.files.internal(getAssetsPath(assetsPath) + fileName + ".fnt"),
    ...
    /** fileName要带上.png或者.jpg之类的后缀 */
    public static Image getImage(AssetManager assetManager, String assetsPath, String fileName, boolean flipX,
	    boolean flipY) {
